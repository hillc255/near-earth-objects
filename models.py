...
class NearEarthObject:
    ...
    def __init__(self, **info):
        ...
        self.hazardous = info.get("hazardous")#pha
    ...
    def __str__(self):
        ...
        if self.hazardous is True:
            ...
            neo_hazard = 'is not'
        return f"A NearEarthObject {self.fullname} has a diameter of {self.diameter} km and {neo_hazard} potentially hazardous."
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        self._designation = info.get('designation')#pdes
        self.time = info.get('time') # TODO: Use the cd_to_datetime function for this attribute.
        self.distance = info.get('distance') #dist - if distance else float('nan')
        self.velocity = info.get('velocity') #v_rel - if velocity else float('nan')
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"A CloseApproach at {self.time_str}, {self.neo.fullname} approaches Earth at a distance of {self.distance} au and a velocity of {self.velocity} km/s."
