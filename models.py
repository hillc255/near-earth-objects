...
class NearEarthObject:
    ...
    # constructor? If you make changes, be sure to update the comments in
    # this file.
    ...
    def fullname(self):
        ...
        # TODO: Use self.designation and self.name to build a fullname
        # for this object.
    ...
    def __str__(self):
        ...
        # representation. The project instructions include one possibility.
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        # data type and handle any edge cases.
    ...
    def time_str(self):
        ...
        # TODO: Use self.designation and self.name to build a fullname for
        # this object.
        if self.time:
